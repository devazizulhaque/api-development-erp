...
use App\Models\AdminLoanType;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class AdminLoanTypeController extends Controller
{
    ...
    {
        $model = AdminLoanType::class; // Or replace this with your model
    ...
    public function store(Request $request)
    {
        ...
        AdminLoanType::createOrUpdate($request);
        return response()->json([
            'code' => '200',
            'status' => true,
            'data' => null,
    ...
    {
        $admin_loantype = AdminLoanType::find($id);
        return response()->json(
            [
                'code' => '200',
                'status' => true,
    ...
    public function update(Request $request, string $id)
    {
        ...
        AdminLoanType::createOrUpdate($request, $id);
        return response()->json([
            'code' => '200',
            'status' => true,
            'data' => null,
    ...
    {
        $adminloantype = new AdminLoanType(); // Create an instance of AdminEmployee
        $data = OverviewHelper::getModelOverview($adminloantype); // Get overview data
        return response()->json(
            [
                'code' => '200',
                'status' => true,
