...
class AdminDesignationController extends Controller
{
    ...
    {
        $model = AdminDesignation::class; // Or replace this with your model
        ...
        $filename = 'admin_designation_list';
    ...
    public function store(Request $request)
    {
        ...
        AdminDesignation::createOrUpdate($request);
        return response()->json([
            'code' => '200',
            'status' => true,
            'data' => null,
    ...
    {
        $admin_designation = AdminDesignation::find($id);
        return response()->json(
            [
                'code' => '200',
                'status' => true,
                'data' => $admin_designation,
                'message' => 'Success',
            ],
            200
        );
    ...
    public function update(Request $request, string $id)
    {
        ...
        AdminDesignation::createOrUpdate($request, $id);
        return response()->json([
            'code' => '200',
            'status' => true,
            'data' => null,
    ...
    {
        $admindesignation = new AdminDesignation(); // Create an instance of AdminEmployee
        $data = OverviewHelper::getModelOverview($admindesignation); // Get overview data
        return response()->json(
            [
                'code' => '200',
                'status' => true,
