...
class AdminLeaveTypeController extends Controller
{
    ...
    {
        $model = AdminLeaveType::class; // Or replace this with your model
    ...
    public function store(Request $request)
    {
        ...
        AdminLeaveType::createOrUpdate($request);
        return response()->json([
            'code' => '200',
            'status' => true,
            'data' => null,
    ...
    {
        $admin_leavetype = AdminLeaveType::find($id);
        return response()->json(
            [
                'code' => '200',
                'status' => true,
                'data' => $admin_leavetype,
                'message' => 'Success',
            ],
            200
        );
    ...
    public function update(Request $request, string $id)
    {
        ...
        AdminLeaveType::createOrUpdate($request, $id);
        return response()->json([
            'code' => '200',
            'status' => true,
            'data' => null,
    ...
    {
        $adminleavetype = new AdminLeaveType(); // Create an instance of AdminEmployee
        $data = OverviewHelper::getModelOverview($adminleavetype); // Get overview data
        return response()->json(
            [
                'code' => '200',
                'status' => true,
